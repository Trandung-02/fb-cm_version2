...
const selectBase =
  'block w-full cursor-pointer rounded-[10px] border bg-white font-medium leading-tight text-[#1f2a45] shadow-sm outline-none transition duration-150 hover:border-[#1877f2] focus-visible:ring-2 focus-visible:ring-[#1877f2]/30'

export default function PrivacyLanguagePicker({ variant = 'default' }: { variant?: 'default' | 'header' }) {
  ...
  const selectClass = isHeader
    ? `${selectBase} min-h-[32px] rounded-[8px] border-[#c5cad3] px-2 py-1 text-[10px] sm:min-h-[34px] sm:px-2.5 sm:text-[11px] md:text-[12px]`
    : `${selectBase} min-h-[34px] border-[#dbe9ff] px-[10px] py-[5px] text-[11px] sm:min-h-[36px] sm:px-[11px] sm:text-[12px]`

  return (
    <div className={isHeader ? 'w-full min-w-0' : 'mx-auto w-full'}>
      <div className={isHeader ? 'w-full min-w-[140px] max-w-[220px] sm:min-w-[160px]' : 'mx-auto w-full max-w-[220px] min-w-0 sm:max-w-[240px]'}>
        <select
